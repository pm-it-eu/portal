...
import { Ticket, Plus, Search, MessageSquare, Lock, Unlock, List } from "lucide-react"
	...
	useEffect(() => {
		...
		const loadTickets = async () => {
			try {
				...
				console.log("Tickets response:", response.status, response.ok)
		...
		<div className="space-y-6">
			<div className="bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 p-6 rounded-xl">
				...
				<p className="text-emerald-700 mt-2">
					Hier können Sie Ihre Support-Tickets verwalten und neue erstellen
				</p>
			</div>
					...
					<div className="flex gap-4">
						...
						<div className="flex-1">
							<div className="relative">
								...
								<Input 
									placeholder="Tickets durchsuchen (Titel, #Nummer)..." 
									className="pl-10"
									value={searchTerm}
			...
			<Card className="bg-white border-gray-200 shadow-sm">
				<CardHeader>
					...
					<CardDescription>
						Übersicht über Ihre offenen Support-Tickets
					</CardDescription>
				</CardHeader>
				<CardContent>
					{loading ? (
									...
									<div className="flex items-center space-x-4">
										...
										<div>
											...
											<p className="text-sm text-gray-600">
												Erstellt {ticket.createdAt ? new Date(ticket.createdAt).toLocaleString("de-DE") : 'Unbekannt'}
											</p>
										</div>
									</div>
			...
			<Card className="bg-white border-gray-200 shadow-sm">
				<CardHeader>
					...
					<CardDescription>
						Alle Ihre Support-Anfragen im Überblick
					</CardDescription>
				</CardHeader>
				<CardContent>
					{loading ? (
